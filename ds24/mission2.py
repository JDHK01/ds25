...
async def run():
    ...
    ser_port.send_lora_packet(LORA_HEADER_SEARCH ,result , footer=LORA_PACKET_FOOTER)
    ...
    if mudi == 'A1':
        ...
        await ctrl.goto_position_ned(drone, 1.4, 0.25, 0.0, 0.0, 20.0)
    elif mudi == 'A2':
        await ctrl.goto_position_ned(drone, 0.0, 0.0, -1.25, 0.0, 20.0)
        await ctrl.goto_position_ned(drone, 0.0, 0.0, -0.95, 0.0, 10.0)
        await ctrl.goto_position_ned(drone, 1.4, 0.0, -0.95, 0.0, 10.0)
        await ctrl.goto_position_ned(drone, 1.4, 1.3, -0.95, 0.0, 10.0)
        await ctrl.goto_position_ned(drone, 1.4, 1.3, 0.0, 0.0, 10.0)
